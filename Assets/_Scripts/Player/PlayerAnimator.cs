...
namespace TarodevController
{
    public class PlayerAnimator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            var xInput = _player.MoveInput.x;
        ...
        private IEnumerator SquishPlayer(float force)
        {
            ...
            while (elapsedTime < duration)
            {
                ...
                _sprite.size = new Vector3(_currentSpriteSize.x * squishFactorX, _currentSpriteSize.y * squishFactorY);

                yield return null;
            }

            _sprite.size = _currentSpriteSize;
            _isSquishing = false;
        }
