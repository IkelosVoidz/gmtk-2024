...
namespace TarodevController
{
    public class PlayerController : MonoBehaviour, IPlayerController, IPhysicsObject
    {
        ...
        private void SetupCharacter()
        {
            ...
            SetColliderSize(_character.StandingColliderSize , _character.StandingColliderCenter);

            // Airborne collider
            _airborneCollider = GetComponent<CapsuleCollider2D>();

            _airborneCollider.direction = ( _character.Width > _character.Height ? CapsuleDirection2D.Horizontal : CapsuleDirection2D.Vertical);
        ...
        private void SetColliderMode(ColliderMode mode)
        {
            ...
            switch (mode)
            {
                ...
                case ColliderMode.Crouching:
                    SetColliderSize(_character.CrouchColliderSize , _character.CrouchingColliderCenter);    
                    break;
