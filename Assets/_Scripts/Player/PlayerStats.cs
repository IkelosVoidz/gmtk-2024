...
namespace TarodevController
{
    ...
    public class PlayerStats : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            var potentialPlayerAnimators = FindObjectsOfType<PlayerAnimator>();
            ...
            foreach (var player in potentialPlayer)
            {
             ...
             foreach (var animator in potentialPlayerAnimators)
            {
                animator.OnValidate();
            }
        }
    ...
    public class CharacterSize
    {
        ...
        [Range(0.1f, 10), Tooltip("The Default width of your collider")]
        public float DefaultWidth = 4f;

        [Range(0.1f, 10), Tooltip("The DefaultHeight of your collider")]
        public float DefaultHeight = 4f;

        public float DefaultArea => DefaultHeight*DefaultWidth; 
